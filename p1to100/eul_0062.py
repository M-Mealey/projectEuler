...
def solve():
    ...
    for x in range(10, 10000):
        ...
        # forms a fingerprint that is the same for all permutations
        digits_sorted = int(
            "".join(sorted(list(str(c)), reverse=True)))
        ...
        if matches == 4:  # if this is the 5th match, search is over, return smallest cube
