...
# probably better to make array of 1M elements, iterate 1 to 1M,
# for each number add it to the element at
...
# 3
# [0, 1, 1, 1, 2, 1, 5, 1, 2, 4 ...]
# then find loops using Floyd's cycle detection algorithm:
...
def solve():
    ...
    for i in range(2, 1000000):
        ...
        while (1 < next_num < 1000000 and next_num not in numbers_this_cycle
               and next_num not in all_numbers_checked):
            numbers_this_cycle.add(next_num)
            next_num = divisor_sums[next_num]
        if (1 < next_num < 1000000 and next_num not in all_numbers_checked
                and next_num in numbers_this_cycle):  # cycle found, starts/ends at next_num
