...
def solve():
    """ solve problem 26 by finding the longest repeating cycle by factoring each denominator
    to remove 5s and 2s, then finding an integer of all 9s that is divisible by the remaining
    product. The length of this all-9s number is the length of the repeating cycle.
